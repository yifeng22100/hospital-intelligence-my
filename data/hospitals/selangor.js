...
var HOSPITALS_SELANGOR = [
  ...
  },
  {
    ...
    nameShort: "Tropicana MC",
    sector: "private", tier: "tertiary", state: "Selangor", city: "Petaling Jaya",
    intro: "Tropicana Medical Centre is a private tertiary hospital in Kota Damansara, Petaling Jaya, offering comprehensive specialist services.",
    famousFor: ["Private tertiary hospital in Kota Damansara", "Comprehensive specialist services"],
    infrastructure: { yearEstablished: 2009, totalBeds: 260, icuBeds: 20, nicuBeds: 8, operatingTheatres: 8, area: "~6 acres", buildings: "Main Block, Specialist Suites", helipad: false, parkingBays: "~500 bays", parkingRate: "RM 2/hour" },
    contact: { address: "No. 11, Jalan Teknologi, Kota Damansara, 47810 Petaling Jaya, Selangor", mainLine: "+603-6287 1111", emergencyLine: "+603-6287 1111 ext. A&E", appointmentLine: "+603-6287 1111", website: "https://www.tropicanaMC.com.my", mapQuery: "Tropicana Medical Centre Kota Damansara" },
    transport: { nearest: "Kota Damansara MRT — 5 min taxi", bus: "Rapid KL T707", highway: "Damansara-Puchong Highway (LDP) / Sprint", landmark: "Kota Damansara, near Sunway Damansara" },
    facilities: { pharmacy24h: true, cafeteria: "Café and restaurant", atm: "Lobby", surau: "Available", chapel: false, buddhistRoom: false, disabledAccess: true, wifi: "Free", patientTransport: "Ambulance" },
    ...
    specialtyCoverage: {
      available: ["Emergency (24/7)", "Cardiology", "General Surgery", "Orthopaedics", "Oncology", "Neurology", "Obstetrics", "Paediatrics", "ENT", "Ophthalmology", "Urology", "Gastroenterology"],
      notAvailable: [{ specialty: "Liver transplant", transferTo: "Hospital Selayang", note: "National centre" }],
      byReferral: ["Complex liver → Hospital Selayang"]
    },
    transferPathway: { summary: "Private tertiary hospital. National cases → public centres.", routes: [], howToTransfer: "Private referral." },
    specialtyRanks: {}, accreditations: ["MOH Licensed", "MSQH Accredited"],
    primaryExcellence: "Private tertiary — Kota Damansara / Petaling Jaya", secondarySpecialties: "Cardiology, Oncology, Orthopaedics",
    ...
    gaps: "No transplant services.", robotics: "Selected imaging.", doctorQualifications: "MOH-registered specialists and consultants.",
    imageUrl: null, imageCredit: "N/A", officialSources: [{ label: "Tropicana Medical Centre", url: "https://www.tropicanaMC.com.my" }],
    verifiedNotes: "~260 beds (est.). Private tertiary, Kota Damansara.", notableGaps: "No transplant services."
  },
  {
    id: "kpj-kajang",
