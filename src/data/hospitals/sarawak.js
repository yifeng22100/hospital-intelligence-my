...
export const HOSPITALS_SARAWAK = [
  {
    id: "hus",
...
,
  {
    ...
    intro: "Hospital Sentosa is the only dedicated psychiatric hospital in Sarawak, located at Batu 7, Jalan Penrissen, Kuching. With 338 beds, it is the apex referral hospital for all psychiatric and mental health cases throughout Sarawak. Originally established in 1958 as the Sarawak Mental Hospital, it was renamed Sentosa Hospital in 1998.",
    famousFor: ["Only psychiatric hospital in Sarawak", "Apex referral centre for all mental health cases in Sarawak", "Established 1958 — one of Sarawak's oldest specialist hospitals", "Serves the entire Sarawak state for psychiatric care"],
    infrastructure: { yearEstablished: 1958, totalBeds: 338, icuBeds: 0, nicuBeds: 0, operatingTheatres: 0, area: "~15 acres", buildings: "Multiple ward blocks, rehabilitation units", helipad: false, parkingBays: "~150 bays", parkingRate: "Free" },
    contact: { address: "Batu 7, Jalan Penrissen, Kuching, Sarawak", mainLine: "+6082-611 399 (verify)", emergencyLine: "+6082-611 399", appointmentLine: "+6082-611 399", website: "https://jknsarawak.moh.gov.my/hsk/", mapQuery: "Hospital Sentosa Kuching Sarawak" },
    transport: { nearest: "Kuching city — ~7 km, 15 min taxi via Jalan Penrissen", bus: "City bus routes (Jalan Penrissen)", highway: "Jalan Penrissen, Kuching", landmark: "Batu 7 Jalan Penrissen, Kuching" },
    ...
    specialtyCoverage: {
      ...
      notAvailable: [{ specialty: "General medical/surgical care", transferTo: "Hospital Umum Sarawak (HUS) Kuching", note: "Psychiatric facility only — medical/surgical cases to HUS" }],
      byReferral: ["All psychiatric referrals from Sarawak -> Hospital Sentosa"]
    },
    transferPathway: { summary: "Hospital Sentosa is the sole psychiatric hospital in Sarawak. All psychiatric cases from Sarawak's hospitals and clinics are referred here. Medical/surgical needs are coordinated with HUS Kuching.", routes: [{ condition: "Medical/surgical complications", to: "Hospital Umum Sarawak (HUS) Kuching", reason: "General medical centre", distanceKm: 7 }], howToTransfer: "MOH psychiatric referral." },
    specialtyRanks: { "Sarawak Psychiatry": { rank: "Only psychiatric hospital in Sarawak", desc: "Apex referral centre for all mental health cases in Sarawak" } },
    accreditations: ["MOH Accredited"],
    primaryExcellence: "Only psychiatric hospital in Sarawak — apex mental health centre", secondarySpecialties: "Forensic Psychiatry, Rehabilitation",
    fullSpecialties: ["Psychiatry", "Rehabilitation"],
    ...
    imageUrl: null, imageCredit: "N/A", officialSources: [{ label: "Official Website", url: "https://jknsarawak.moh.gov.my/hsk/" }, { label: "MOH Malaysia", url: "https://www.moh.gov.my" }],
    verifiedNotes: "338 beds. Only psychiatric hospital in Sarawak. Established 1958, renamed 1998. Apex referral for mental health across Sarawak.", notableGaps: "Psychiatric only — medical/surgical to HUS Kuching."
  },
  {
    id: "hrcbm", name: "Hospital Rajah Charles Brooke Memorial Kuching", nameShort: "Hospital Rajah Charles Brooke",
    sector: "public", tier: "district", state: "Sarawak", city: "Kuching",
    ...
    specialtyCoverage: {
      available: ["Long-term care", "Rehabilitation", "Dermatology (leprosy)", "Outpatient clinic"],
      notAvailable: [{ specialty: "Acute specialist care", transferTo: "Hospital Umum Sarawak (HUS) Kuching", note: "Special institution — acute cases to HUS Kuching" }],
      byReferral: ["Acute specialist cases -> HUS Kuching (~13 km)"]
    },
    transferPathway: { summary: "Special institution hospital. Acute and specialist cases are referred to HUS Kuching.", routes: [{ condition: "Acute specialist care", to: "Hospital Umum Sarawak (HUS) Kuching", reason: "Nearest apex centre", distanceKm: 13 }], howToTransfer: "MOH referral." },
    specialtyRanks: {}, accreditations: ["MOH Accredited"],
    primaryExcellence: "Special institution hospital — historical leprosarium, long-term care, Kuching", secondarySpecialties: "Rehabilitation, Dermatology (leprosy)",
    fullSpecialties: ["Long-term care", "Rehabilitation", "Dermatology"],
    roomRate: "Free (public)", roomRateRaw: 0, insurance: "Heavily subsidised.", fppScheme: false, fppDeposit: "N/A",
    gaps: "Special institution only — not a general acute hospital.", robotics: "None.", doctorQualifications: "MOH medical officers.",
    imageUrl: null, imageCredit: "N/A", officialSources: [{ label: "MOH Malaysia", url: "https://www.moh.gov.my" }],
    verifiedNotes: "~100 beds (est.). Historical leprosarium, special institution. Located Batu 13 Jalan Puncak Borneo, Kota Padawan, Kuching.", notableGaps: "Acute specialist cases to HUS Kuching."
  },
  {
    id: "hkanowit", name: "Hospital Kanowit", nameShort: "Hospital Kanowit",
    sector: "public", tier: "district", state: "Sarawak", city: "Kanowit",
    ...
    specialtyCoverage: {
      ...
      notAvailable: [{ specialty: "Specialist services", transferTo: "Hospital Sibu", note: "District hospital" }],
      byReferral: ["Specialist -> Hospital Sibu"]
    },
    transferPathway: { summary: "District hospital. Complex -> Hospital Sibu (~60 km).", routes: [], howToTransfer: "MOH referral." },
    specialtyRanks: {}, accreditations: ["MOH Accredited"],
    primaryExcellence: "District hospital — Kanowit, Sibu Division", secondarySpecialties: "General Medicine, Obstetrics",
    fullSpecialties: ["General Medicine", "Surgery", "Obstetrics"],
    roomRate: "Free (public)", roomRateRaw: 0, insurance: "MyCard / MySalam.", fppScheme: false, fppDeposit: "N/A",
    gaps: "Limited specialist services.", robotics: "None.", doctorQualifications: "MOH medical officers.",
    imageUrl: null, imageCredit: "N/A", officialSources: [{ label: "MOH Malaysia", url: "https://www.moh.gov.my" }],
    verifiedNotes: "100 beds. District hospital for Kanowit, Sibu Division. Jalan Kanowit/Durin.", notableGaps: "Specialist referral to Hospital Sibu."
  },
  {
    id: "hsaratok", name: "Hospital Saratok", nameShort: "Hospital Saratok",
    sector: "public", tier: "district", state: "Sarawak", city: "Saratok",
    ...
    specialtyCoverage: {
      available: ["Emergency (24/7)", "General Medicine", "General Surgery (basic)", "Obstetrics", "Paediatrics"],
      notAvailable: [{ specialty: "Specialist services", transferTo: "Hospital Sri Aman / HUS Kuching", note: "District hospital" }],
      byReferral: ["Specialist -> Hospital Sri Aman or HUS Kuching"]
    },
    transferPathway: { summary: "District hospital for Saratok. Complex -> Hospital Sri Aman or HUS Kuching.", routes: [], howToTransfer: "MOH referral." },
    specialtyRanks: {}, accreditations: ["MOH Accredited"],
    primaryExcellence: "District hospital — Saratok, Sri Aman Division", secondarySpecialties: "General Medicine, Obstetrics",
    fullSpecialties: ["General Medicine", "Surgery", "Obstetrics"],
    roomRate: "Free (public)", roomRateRaw: 0, insurance: "MyCard / MySalam.", fppScheme: false, fppDeposit: "N/A",
    gaps: "Limited specialist services.", robotics: "None.", doctorQualifications: "MOH medical officers.",
    imageUrl: null, imageCredit: "N/A", officialSources: [{ label: "MOH Malaysia", url: "https://www.moh.gov.my" }],
    verifiedNotes: "106 beds. District hospital for Saratok, Sri Aman Division.", notableGaps: "Specialist referral to Hospital Sri Aman or HUS Kuching."
  },
  {
    id: "hlundu", name: "Hospital Lundu", nameShort: "Hospital Lundu",
    sector: "public", tier: "district", state: "Sarawak", city: "Lundu",
    ...
    specialtyCoverage: {
      available: ["Emergency (24/7)", "General Medicine", "Obstetrics (basic)"],
      notAvailable: [{ specialty: "Specialist services", transferTo: "HUS Kuching (~80 km)", note: "Small district hospital" }],
      byReferral: ["Specialist -> HUS Kuching"]
    },
    transferPathway: { summary: "Small district hospital. Complex -> HUS Kuching (~80 km).", routes: [], howToTransfer: "MOH referral." },
    specialtyRanks: {}, accreditations: ["MOH Accredited"],
    primaryExcellence: "District hospital — Lundu, westernmost Sarawak", secondarySpecialties: "General Medicine",
    fullSpecialties: ["General Medicine", "Obstetrics"],
    roomRate: "Free (public)", roomRateRaw: 0, insurance: "MyCard / MySalam.", fppScheme: false, fppDeposit: "N/A",
    gaps: "Very limited services.", robotics: "None.", doctorQualifications: "MOH medical officers.",
    imageUrl: null, imageCredit: "N/A", officialSources: [{ label: "MOH Malaysia", url: "https://www.moh.gov.my" }],
    verifiedNotes: "~60 beds (est.). District hospital for Lundu, Kuching Division.", notableGaps: "Specialist referral to HUS Kuching."
  },
  {
    id: "hsimunjan", name: "Hospital Simunjan", nameShort: "Hospital Simunjan",
    sector: "public", tier: "district", state: "Sarawak", city: "Simunjan",
    ...
    specialtyCoverage: {
      available: ["Emergency (24/7)", "General Medicine", "Obstetrics (basic)"],
      notAvailable: [{ specialty: "Specialist services", transferTo: "Hospital Samarahan / HUS Kuching", note: "Small district hospital" }],
      byReferral: ["Specialist -> Hospital Samarahan or HUS Kuching"]
    },
    transferPathway: { summary: "Small district hospital. Complex -> Hospital Samarahan or HUS Kuching.", routes: [], howToTransfer: "MOH referral." },
    specialtyRanks: {}, accreditations: ["MOH Accredited"],
    primaryExcellence: "District hospital — Simunjan, Samarahan Division", secondarySpecialties: "General Medicine",
    fullSpecialties: ["General Medicine", "Obstetrics"],
    roomRate: "Free (public)", roomRateRaw: 0, insurance: "MyCard / MySalam.", fppScheme: false, fppDeposit: "N/A",
    gaps: "Very limited services.", robotics: "None.", doctorQualifications: "MOH medical officers.",
    imageUrl: null, imageCredit: "N/A", officialSources: [{ label: "MOH Malaysia", url: "https://www.moh.gov.my" }],
