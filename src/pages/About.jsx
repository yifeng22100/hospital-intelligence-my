...
const ROADMAP = [
  ...
  { status: 'live', label: 'Intelligence Hub — 7 topics: insider tips, hospital tiers, specialist directory by hospital, medical tourism hub (JCI hospitals, visa process, cost comparisons), a dated changelog of industry changes, clinical trials, overnight care' },
  { status: 'live', label: 'Insurance Hub — premiums, takaful vs conventional, terms, interactive premium calculator' },
  { status: 'live', label: 'Knowledge Hub — 18 topics: A&E triage guide, patient journey guides, appointment booking guide, pharmacy & vaccination locator, glossary, drugs, lab values, screening, maternal, vaccination (COVID-19/Flu/Dengue & Tropical), children, elderly, mental health, medical reports, post-discharge care, a drug interaction checker, chronic disease self-monitoring, and a second opinion navigator' },
  { status: 'live', label: 'Lifestyle Hub — 9 sections: healthy eating, condition-specific diet therapy, exercise, sleep, chronic disease prevention, dengue prevention, quit smoking, stress & mental wellness, weight management' },
