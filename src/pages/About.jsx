...
const ROADMAP = [
  ...
  { status: 'live', label: 'Knowledge Hub — 10 topics: glossary, drugs, lab values, screening, maternal, vaccination (COVID-19/Flu/Dengue & Tropical), children, elderly, mental health, medical reports' },
  ...
  { status: 'live', label: 'Tools — Cost Estimator, Panel Lookup (13 insurers, verified 2025 hotlines), Premium Calculator' },
