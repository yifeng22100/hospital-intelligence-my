...
const ROADMAP = [
  ...
  { status: 'live', label: 'Knowledge Hub — 17 topics organised into 4 groups (Emergencies & Getting Care, Understanding Your Care, Life Stage Care, Ongoing & Chronic Care), navigable via a sidebar like the Lifestyle Hub' },
