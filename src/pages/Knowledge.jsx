...
const PATIENT_JOURNEYS = {
  ...
  colonoscopy: {
    ...
    steps: [
      ...
      { step: '2', title: 'Understand the cost', color: '#d97706', detail: 'Private colonoscopy in Malaysia typically runs RM 1,500–RM 3,500 depending on hospital and sedation; adding a polypectomy (polyp removal) adds RM 300–800 more. See Tools → Cost Reference for the full public/private breakdown.' },
